# Ubuntu Server
# ---
# This is the config for a VM template of an Ubuntu Server on Proxmox
...
source "proxmox-iso" "ubuntu-server-AD" {
  ...
  vm_id                = "401" # The ID of the VM, used during creation
  vm_name              = "ubuntu-template-AD" #this is the name of the template (The artifact created by packer)
  ...
  # ssh_password = "no"
  ssh_private_key_file = "/home/louis_declerck/.ssh/id_rsa"
